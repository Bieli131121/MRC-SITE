      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        <div className="cta-inner">
          ...
          <div className="cta-action">
            ...
            <div style={{ fontFamily: 'var(--font-cond)', fontSize: '0.68rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-muted)' }}>✓ Visita técnica gratuita &nbsp;·&nbsp; ✓ Sem compromisso</div>
          </div>
        </div>
      </div>
