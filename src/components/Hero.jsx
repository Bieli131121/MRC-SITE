  ...
  return (
    <section style={{
      ...
      <div className="hero-deco" style={{
        ...
        fontFamily: 'var(--font-display)', fontSize: 'clamp(120px, 22vw, 420px)', fontWeight: 900,
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2, paddingTop: '6rem', paddingBottom: '4rem' }}>
        <div style={{ maxWidth: '700px' }}>
          ...
          <h1 className="fade-up fade-up-2" style={{
            ...
            fontWeight: 900, lineHeight: 1.08, color: 'var(--cream)',
          ...
          <p className="fade-up fade-up-3" style={{
            ...
            maxWidth: '520px', marginBottom: '2.2rem',
          }}>
          ...
          <div className="fade-up fade-up-4 hero-btns">
          ...
          <div className="fade-up fade-up-4 hero-stats">
            {[{ n: '+200', label: 'Obras Concluídas' }, { n: '12+', label: 'Anos de Experiência' }, { n: '98%', label: 'Clientes Satisfeitos' }].map(s => (
              <div key={s.n}>
                <div style={{ fontFamily: 'var(--font-display)', fontSize: '2rem', fontWeight: 700, color: 'var(--gold)', lineHeight: 1 }}>{s.n}</div>
                <div style={{ fontFamily: 'var(--font-cond)', fontSize: '0.68rem', fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--text-muted)', marginTop: '0.35rem' }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="scroll-indicator" style={{
        ...
        <div style={{ width: '1px', height: '40px', background: 'linear-gradient(to bottom, var(--gold), transparent)', animation: 'fadeUp 1.5s ease infinite alternate' }} />
      </div>
      ...
      <style>{`
        ...
        @media (max-width: 480px) {
          ...
          .hero-stats { gap: 1.8rem; margin-top: 2.5rem; }
          .hero-deco, .scroll-indicator { display: none; }
        }
      `}</style>
    </section>
  )
